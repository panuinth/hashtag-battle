...
$(function() {
  ...
  source.addEventListener("battle:hashtag:"+ battleId, function(e) {
    ...
    if (keywordTitle.length > 0) {
      ...
      var temp = '<div class="brick {size}" style="background-color: {color}"><div class="cover" id='+ result.keyword +'><h2 style="text-align:center;color:#fff;margin-top:15px;">#'+ result.keyword +'</h2><p class="counter" style="font-size:50px;text-align:center;color:#fff;">0</p></div></div>';
